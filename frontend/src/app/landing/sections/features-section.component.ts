...
import { getAllFeatures } from '../features/features.metadata';   // ← Import from metadata
                            ...
                            <div class="flip-card-back bg-brand-950 text-white rounded-3xl p-10 flex flex-col justify-center border border-brand-500/30">
                                ...
                                <div class="mt-auto">
                                    <a [routerLink]="['/features', feature.id]"
                                       class="inline-flex items-center gap-2 text-brand-400 hover:text-white font-medium transition-colors">
                                        Learn more
...
export class FeaturesSectionComponent {
    features = getAllFeatures();   // ← This pulls all features with proper routes
}